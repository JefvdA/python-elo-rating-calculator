def calculate_expected_outcome(own_rating: int, other_rating: int, c: int) -> float:
    """
    This function calculates the expected outcome of a match where both players are rated using the elo system.
     See calculation documented below. Keep in mind that this result will be rounded to 2 decimal points.
